...
for.end:                                          ; preds = %for.body
  %cmp3 = icmp sgt i32 %cond, 10, !dbg !43, !my.md.blinded !44
  %idxprom4 = sext i32 %idx1 to i64, !dbg !45
  %arrayidx5 = getelementptr inbounds [10 x i32], [10 x i32]* %a, i64 0, i64 %idxprom4, !dbg !45
  %idxprom6 = sext i32 %idx2 to i64, !dbg !45
  %arrayidx7 = getelementptr inbounds [10 x i32], [10 x i32]* %b, i64 0, i64 %idxprom6, !dbg !45
  %4 = ptrtoint i32* %arrayidx5 to i64, !dbg !45
  %5 = ptrtoint i32* %arrayidx7 to i64, !dbg !45
  %6 = sub i1 false, %cmp3, !dbg !45
  %7 = sext i1 %6 to i64, !dbg !45
  %8 = xor i64 %4, %5, !dbg !45
  %9 = and i64 %7, %8, !dbg !45
  %10 = xor i64 %9, %5, !dbg !45
  %11 = inttoptr i64 %10 to i32*, !dbg !45
  %cond8 = load i32, i32* %11, align 4, !dbg !45, !tbaa !32
  ret i32 %cond8, !dbg !46
}
...
!44 = !{i64 1}
!45 = !DILocation(line: 18, column: 10, scope: !7)
